...
cE.icon = "__MF_Base_zoms__/graphics/items/Crystallizer.png"
cE.icon_size = 32
  ...
  animation =
    {
      ...
      {
        {
            filename = "__MF_Base_zoms__/graphics/entities/Crystallizer.png",
            priority = "high",
            width = 214,
            height = 218,
            frame_count = 32,
...
cI.icon = "__MF_Base_zoms__/graphics/items/Crystallizer.png"
cI.icon_size = 32
