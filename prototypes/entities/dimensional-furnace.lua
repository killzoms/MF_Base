...
dfE.icon = "__MF_Base_zoms__/graphics/items/DimensionalFurnace.png"
dfE.icon_size = 32
  ...
  animation =
    {
      ...
      {
        {
            filename = "__MF_Base_zoms__/graphics/entities/DimensionalFurnace.png",
            priority = "high",
            width = 239,
            height = 219,
            frame_count = 1,
...
dfI.icon = "__MF_Base_zoms__/graphics/items/DimensionalFurnace.png"
dfI.icon_size = 32
...
dfT.type = "technology"
dfT.icon = "__MF_Base_zoms__/graphics/items/DimensionalFurnace.png"
dfT.icon_size = 32
dfT.unit = {
	count=150,
	time=2,
